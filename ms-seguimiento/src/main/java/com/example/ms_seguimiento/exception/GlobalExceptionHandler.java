package com.example.ms_seguimiento.exception;
...
// ... código de los otros ExceptionHandler ...
    ...
    // 3. Atrapa errores cuando mandan un dato que no coincide con el tipo esperado (Ej. Enum)
    @ExceptionHandler(HttpMessageNotReadableException.class)
    public ResponseEntity<Map<String, String>> manejarErrorDeFormato(HttpMessageNotReadableException ex) {
        Map<String, String> error = new HashMap<>();
        // Cambiamos el texto para que tenga sentido en cualquier microservicio
        error.put("error", "Error en el formato de los datos enviados. Verifica que los textos correspondan a los estados o listas permitidas y estén en MAYÚSCULAS.");
